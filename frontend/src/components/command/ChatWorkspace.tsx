...
// POST /conversations/{id}/messages — there is no local/fake AI. Full height: a slim New-chat
// action row, a scrolling message stream, and a sticky composer.
export function ChatWorkspace() {
  ...
  return (
    <div className="flex h-full flex-col">
      {/* Slim action row — just New chat (the identity/status strip and document-status card
          were removed, so the content sits higher and cleaner). */}
