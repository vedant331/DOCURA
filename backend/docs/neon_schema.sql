-- =============================================================================
-- DOCURA — flattened PostgreSQL schema (Neon-ready)
--
-- This is the FINAL schema at Alembic HEAD e1f2a3b4c5d6, flattened from the
-- migration chain into one standalone script for a fresh, empty database.
--
